...
## Important Note
This project was created as an example use case of ButterCMS in conjunction with a blog article, [How to Create Dynamic PHP Landing Pages Using ButterCMS](https://buttercms.com/blog/create-dynamic-php-landing-pages/), and will not be actively maintained.
